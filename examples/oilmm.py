...
# drivers. This gives the OILMM two meaningful latent processes to recover.
#
# We subsample the ERA5 record, standardise time and each output for stable
# optimisation, and map predictions back to hours and metres for plotting.
#
...
# %% [markdown]
# The total series rises with both component series, while swell and wind sea vary
